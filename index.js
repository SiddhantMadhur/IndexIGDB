...
async function getGames(offset) {
  ...
  const gameRequest = await fetch("https://api.igdb.com/v4/games", {
    ...
    body: `fields id, parent_game, category, name, slug, first_release_date, cover.url, cover.width, cover.height; where version_parent=null; sort id asc;  limit ${limit}; offset ${offset};`,
  });
